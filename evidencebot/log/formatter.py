...
class EvidenceBotLogFormatter(logging.Formatter):
    """
    Defines the log formatting for EvidenceBot
    """
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        if not record.exc_info:
            return super(EvidenceBotLogFormatter, self).format(record)
        ...
        with contextlib.ExitStack() as stack:
            ...
            base_output = super(EvidenceBotLogFormatter, self).format(record)
            full_message = record.message
