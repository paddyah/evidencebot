...
class EvidenceBotLogger(logging.Logger, io.IOBase):
    """
    ...
    def _log(  # type: ignore
        ...
        try:
            ...
            # If we can't extract EvidenceBot logging metadata, just do the best we can
            super(EvidenceBotLogger, self)._log(
                logging.ERROR,
    ...
    def write(self, msg: str) -> None:
        ...
        calls to print made within the evidencebot repo and print them as info
        instead of debug.
        """
        ...
        if self.is_interactive:
            ...
            if print_frame is not None:
                ...
                if print_frame.filename.startswith(evidencebot_context):
                    # If someone puts a print statement inside evidencebot code,
                    # output it regardless of log level
                    self.info(msg, extra=log_extra)
                else:
                    # Use debug logging for any non-evidencebot modules using print
